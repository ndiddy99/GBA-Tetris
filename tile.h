...
const u16 tileData[] = {
                    0xE0E8, 0xE0E0, 0xE0E0, 0xE8E0, 0xF0E0, 0xF0F0, 0xF0F0, 0xE0F0, 0xF0E0, 0xF0F0, //tile
                    0xF0F0, 0xE0F0, 0xF0E0, 0xF0F0, 0xF0F0, 0xE0F0, 0xF0E0, 0xF0F0, 0xF0F0, 0xE0F0,
                    0xF0E0, 0xF0F0, 0xF0F0, 0xE0F0, 0xE8E0, 0xE8E8, 0xE8E8, 0xE0E8, 0xE0E8, 0xE0E0,
                    0xE0E0, 0xE8E0,0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, //blank
                    0x0000, 0x0000,0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
                    0x0000, 0x0000,0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000,
                    0x0000, 0x0000,0x0000, 0x0000,0x1414, 0x1414, 0x1414, 0x1414, 0xF9F9, 0xF9F9, //wall
                    0xF9F9, 0xF9F9, 0x1414, 0x14F9,0x1414, 0x1414, 0x1414, 0x14F9, 0x1414, 0x1414,
                    0x1414, 0x14F9, 0x1414, 0x1414,0xF9F9, 0xF9F9, 0xF9F9, 0xF9F9, 0x1414, 0x1414,
                    0xF914, 0x1414, 0x1414, 0x1414, 0xF914, 0x1414,0x0000, 0x0000, 0x0000, 0x0000, //text starts after the 1414s
                    0x0000, 0xFFFF, 0xFFFF, 0x0000, 0xFF00, 0xFFFF,0xFFFF, 0x00FF, 0xFFFF, 0x0000,
                    0x0000, 0xFFFF, 0xFFFF, 0x0000, 0x0000, 0xFFFF, 0xFFFF, 0x0000, 0x0000, 0xFFFF,
                    0xFFFF, 0x0000, 0x0000, 0xFFFF, 0xFFFF, 0x0000,0x0000, 0xFFFF,0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xFFFF,
                    0xFFFF, 0x00FF, 0xFF00, 0x0000, 0x0000, 0x00FF, 0xFF00, 0xFFFF, 0xFFFF, 0x0000,
                    0xFF00, 0x0000, 0x0000, 0x0000, 0xFF00, 0x0000, 0x0000, 0x0000, 0x0000, 0xFFFF,
                    0xFFFF, 0x0000,0x00FF, 0x0000, 0x0000, 0x00FF, 0xFFFF, 0x0000, 0xFF00, 0x00FF, 0xFF00, 0x00FF,
                    0xFFFF, 0x0000, 0x0000, 0xFFFF, 0x00FF, 0x0000, 0x0000, 0xFFFF, 0x00FF, 0x0000,
                    0xFF00, 0x00FF, 0xFFFF, 0x0000, 0xFFFF, 0x0000, 0xFF00, 0x00FF, 0x00FF, 0x0000,
                    0x0000, 0x00FF,0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0xFF00, 0x00FF, 0x0000, 0x0000, 0xFF00,
                    0x00FF, 0x0000, 0xFF00, 0xFFFF, 0xFFFF, 0x00FF, 0x0000, 0xFF00, 0x00FF, 0x0000,
...
unsigned char tiles_Map[1024] = { //0=filled, 1=transparent
